          ...
          Row(
            children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        ...
                        PList(name: "Earth", distance: "1au", imagepath: "earth.png", width: width, height: height,isSelected : true),
                      GestureDetector(
                        onTap: () =>  Navigator.of(context).push(
                          PageRouteBuilder(
                            opaque: true, // set to false
              ...
              Container(
                ...
                child: Stack(
                  children: [
                    PDetails(name: "Earth", shortdesc: '''Earth is the third planet from the Sun and the only astronomical object known to harbour and support life.\n Its hydrosphere is the only one in the Solar system sustaining large bodies of liquid surface water. ''', imagepath: "Earthwhole.gif", width: width, height: height,moons: 1, moon: "moon.png",)
                  ],
                )
              )
            ],
