          ...
          Row(
            children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        ...
                        PList(name: "Uranus", distance: "19.2au", imagepath: "uranus.png", width: width, height: height,isSelected : true),
                      GestureDetector(
                        onTap: () =>Navigator.of(context).push(
                          PageRouteBuilder(
                            opaque: true, // set to false
              ...
              Container(
                ...
                child: Stack(
                  children: [
                    PDetails(name: "Uranus", shortdesc: '''Uranus is the seventh planet from the Sun. Its name is a reference to the Greek god of the sky, Uranus, who, according to Greek mythology, was the great-grandfather of Ares (Mars), grandfather of Zeus (Jupiter) and father of Cronus (Saturn). ''', imagepath: "Uranuswhole.gif", width: width, height: height,moons: 3,moon2: "Miranda.png", moon: "Ariel.jpg", moon3 : "Umbriel.jpg",)
                  ],
                )
              )
            ],
