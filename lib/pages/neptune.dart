          ...
          Row(
            children: [
                ...
                padding:const EdgeInsets.only(left: 8),
                  ...
                  child: Column(
                    children: [
                      ...
                      PList(name: "Neptune", distance: "30.06au", imagepath: "neptune.png", width: width, height: height,isSelected : true),
                      GestureDetector(
                        onTap: () => Navigator.of(context).push(
                          PageRouteBuilder(
                            opaque: true, // set to false
              ...
              Container(
                ...
                child: Stack(
                  children: [
                    PDetails(name: "Neptune", shortdesc: '''Neptune is the eighth planet.\nIn the Solar System, it is the fourth-largest planet by diameter, the third-most-massive planet,\nand the densest giant planet. It is 17 times the mass of Earth''', imagepath: "Neptunewhole.gif", width: width, height: height,moons: 3,moon: "Triton.png", moon3: "Proteus.jpg",moon2: "Nereid.png",)
                  ],
                )
              )
            ],
