          ...
          Row(
            children: [
                ...
                padding:const EdgeInsets.only(left: 8),
                  ...
                  child: Column(
                    children: [
                        ...
                        PList(name: "Mercury", distance: "0.39au", imagepath: "mercury.png", width: width, height: height,isSelected : true),
                      GestureDetector(
              ...
              Container(
                ...
                child: Stack(
                  children: [
                    PDetails(name: "Mercury", shortdesc: '''Mercury is the smallest planet in the Solar System and the closest to the Sun.\n Its orbit around the Sun takes 87.97 Earth days, the shortest of all the Sun's planets.''', imagepath: "Mercurywhole.gif", width: width, height: height, moons: 0,)
                  ],
                )
              )
            ],
